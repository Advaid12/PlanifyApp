  ...
  useEffect(() => {
    const fetchStatuses = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:5000/api/client-projects/${email}`);
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.topButtons}>
        <TouchableOpacity onPress={() => navigation.navigate("ClientDashboard")} style={styles.navButton}>
          <Text style={styles.navButtonText}>➕ Add Project</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate("ClientHome")} style={styles.navButton}>
